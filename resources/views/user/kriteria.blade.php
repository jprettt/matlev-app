                                    ...
                                    @else
                                        ...
                                        @foreach($level->evidenceRequirements as $requirement)
                                            ...
                                            @php
                                                ...
                                                $allMultiSlotApproved = $slots->count() > 1 && $approved === $slots->count() && $pending === 0 && $rejected === 0;
                                                $statusMeta = [
                                                ...
                                                if ($allMultiSlotApproved) {
                                                    $currentStatus['container'] = 'border border-emerald-200 bg-emerald-50/80 shadow-sm';
                                                }
