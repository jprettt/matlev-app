...
@php
    ...
    $selectedCriteria = $selectedLevel ? $criterias->first(fn ($criteria) => $criteria->subKriterias->flatMap(fn ($sub) => $sub->maturityLevels)->contains('id', $selectedLevel)) : null;
