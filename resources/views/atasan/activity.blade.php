...
<div class="space-y-6">
    <header class="mb-6 flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
        <div><p class="text-xs font-bold uppercase tracking-[0.2em] text-blue-700">Audit Sistem Penilaian</p><h1 class="mt-2 text-2xl font-bold sm:text-3xl">Riwayat Aktivitas</h1><p class="mt-1 text-sm text-slate-600">Urutan aktivitas User dan Verifikator Admin berdasarkan waktu.</p></div>
    </header>
